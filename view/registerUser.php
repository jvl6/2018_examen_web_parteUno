...
<head>
    ...
    <title>Feria de la Música - Registro</title>
...
<body>
    <nav class="navbar navbar-dark">
        ...
        <div class="collapse navbar-collapse" id="navbarNav">
            <ul class="navbar-nav">
                ...
                <li class="nav-item">
                    <a class="nav-link" href="mision.php">Misión y Visión</a>
                </li>
                <li class="nav-item">
        ...
        <div class="modal-dialog" role="document">
            ...
            <div class="modal-body">
                <form action="../controller/login.php" method="post">
                        ...
                        <a href=""><button type="button" class="btn btn-success">Registrar</button></a>
    ...
    <div class="container text-white rounded" style="width:50%;">
        <form action="../controller/registerUser.php">
            <h1>Registro</h1>
            ...
            <input class="btn btn-success" type="submit" value="Registrar" role="button">
        </form>
