...
<head>
    ...
    <title>Feria de La Música - Inicio</title>
...
<body>
    <nav class="navbar navbar-dark">
        ...
        <div class="collapse navbar-collapse" id="navbarNav">
            <ul class="navbar-nav">
                ...
                <li class="nav-item">
                    <a class="nav-link" href="view/mision.php">Misión y Visión</a>
                </li>
                <li class="nav-item">
            ...
            <div class="modal-body">
                <form action="./controller/login.php" method="post">
                        <div class="form-group">
                            <input type="text" class="form-control" name="user" placeholder="Usuario/a" required>
                        </div>
                        ...
                        <input type="hidden" id="location" name="location" value="../index.php">

                        <button type="button" class="btn btn-secondary" data-dismiss="modal">Cerrar</button>
                        <a href="view/registerUser.php"><button type="button" class="btn btn-success">Registrar</button></a>
    ...
    <div class="container text-white rounded">
        <h1>Bienvenido a Feria de la Música, la mejor tienda de música online.</h1>
        <p class="lead">Para ver el catálogo de productos, o ingresar como usuario, utilice la barra superior.</p>
        <br>
    </div>
